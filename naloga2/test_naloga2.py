...
def test_naloga2(case_dir, case_id):
    ...
    if success_izhod != 1:
        print(len(izhod), len(data['izhod']))
        print(' ✗ Napačen izhod')
    if success_r != 1:
...
if __name__ == "__main__":
    ...
    main(*sys.argv[1:])
    # test_naloga2("lanskiPrimeri", 1)
    # test_naloga2("lanskiPrimeri", 2)
    # test_naloga2("lanskiPrimeri", 3)
    # test_naloga2("lanskiPrimeri", 4)
    # test_naloga2("lanskiPrimeri", 5)
    # test_naloga2("lanskiPrimeri", 6)
    # test_naloga2("lanskiPrimeri", 7)
    # test_naloga2("lanskiPrimeri", 8)
    # test_naloga2("lanskiPrimeri", 9)
    # test_naloga2("lanskiPrimeri", 10)
    for i in range(10):
        test_naloga2('skriti', i+1)
